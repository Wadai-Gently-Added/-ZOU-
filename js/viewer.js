...
let lastDist = null; // ※lastMid(2指の中点)は計算するだけで一度も参照されていないため削除済み
let panStart = null;
...
/* ---- wake lock (常時点灯) ----
   TODO(未検証): iPhone 8+で機能しない報告があり、15秒おきの自動再取得を追加済みだが再テスト待ち。
   iPad Pro(UAがMac名乗りになる問題への対応込み)も表示確認が取れていない */
